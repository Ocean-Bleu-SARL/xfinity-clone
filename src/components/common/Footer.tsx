...
const Footer = () => {
  ...
  return (
    <div className='py-7 h-fit w-full bg-primary px-[8%] flex mmd:flex-col md:justify-between'>
      ...
      <div className='order-1 text-sm flex gap-4 items-top md:w-2/5 justify-start mmd:mb-6 md:justify-end'>
