    ...
    return (
        <div className={`relative ${className}`}>
            <input
                ...
                className={`${inputClassName} block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent border border-1 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer`}
